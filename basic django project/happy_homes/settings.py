"""
Django settings for happy_homes project.
...
SECRET_KEY = 'django-insecure-a34^x=t9v=$%ipo6rejt#)(t4$*d$0&#$&zrk#^udpgp-reyws'
...
WSGI_APPLICATION = 'happy_homes.wsgi.application'
